...
export const STAGES = [
  ...
  },
  {
    ...
    waves: [
      ...
      { enemies: [{ type: ENEMY_TYPE.MAGIC_IMMUNE, count: 4, interval: 2000 }, { type: ENEMY_TYPE.SHIELDED, count: 3, interval: 2500 }] },
    ],
  },
  {
    id: 4,
  ...
  },
  {
    ...
    waves: [
      ...
      { enemies: [{ type: ENEMY_TYPE.SWARM, count: 20, interval: 150 }, { type: ENEMY_TYPE.BERSERKER, count: 8, interval: 500 }, { type: ENEMY_TYPE.AERIAL, count: 6, interval: 1000 }] },
    ],
  },
  {
    id: 9,
